...
| @id | http://data.odeuropa.eu/smell/e200f9fa-c5ba-5019-87dc-67cb28b4a668 |
| @graph | http://data.odeuropa.eu/medical-heritage |
| label | odors |
| source.@id | http://data.odeuropa.eu/source/573be5cb-75ea-5fd6-b98c-8ada37e3be9a |
| source.excerpts.0.@id | http://data.odeuropa.eu/source/573be5cb-75ea-5fd6-b98c-8ada37e3be9a/fragment/06d13013-4099-5447-bf9b-a795ed9a146b |
| source.excerpts.0.value | 25J green caterpillars with broken black bands .A peculiarity of this kind of caterpillar is that when touched or irritated in any way it shoots out from between the segments close to the head a forked , orange - colored process , which emits a very disagreeable odor , and this is its only means of defence .No trace of the pro - cess is visible when the insect is at rest , and the horns are with - drawn just as soon as irritation ceases . |
| source.excerpts.0.words.0 | odor |
| source.excerpts.0.words.1 | very disagreeable |
| source.excerpts.1.@id | http://data.odeuropa.eu/source/573be5cb-75ea-5fd6-b98c-8ada37e3be9a/fragment/0e516e79-d31d-5d9f-9531-a19aec94dadf |
| source.excerpts.1.value | In form they vary , being sometimes broadly oval , sometimes quite narrow .The antennae are usually long and prominent , and the â   buggyâ   odor is well developed .We have a number of species abundant enough to be injurious , and the question of dealing with them is sometimes complicated . |
| source.excerpts.1.words.0 | odor |
| source.excerpts.1.words.1 | â |
| source.excerpts.2.@id | http://data.odeuropa.eu/source/573be5cb-75ea-5fd6-b98c-8ada37e3be9a/fragment/133fe852-985f-5736-a233-1b52e6f632fb |
| source.excerpts.2.value | Living larvae are produced as well as eggs almost ready to hatch , and into any opening from which there is a discharge of any kind eggs may be deposited .Sleeping humans with an offen - sive breath , or with a fetid discharge from the nostrils or mouth , have had eggs laid at these points , and larvae have made their way into the head , in some cases causing the death of the individual .Eggs have also been laid in the ears of uncleanly people , and the channels and passages of this organ have been penetrated into the head and destroyed . |
| source.excerpts.2.words.0 | fetid |
| source.excerpts.2.words.1 | breath |
| source.excerpts.2.words.2 | sive |
| source.excerpts.2.words.3 | discharge |
| source.excerpts.2.words.4 | Sleeping humans |
| source.excerpts.3.@id | http://data.odeuropa.eu/source/573be5cb-75ea-5fd6-b98c-8ada37e3be9a/fragment/17c8852b-1295-5404-af23-8d9ec4fdb91a |
| source.excerpts.3.value | The flies can be kept from the animals by the use of fish oil and crude carbolic acid , applied to those parts not readily reached by the tail .The proportions of fish oil and carbolic acid are not im - portant ; enough of the crude acid to give a decided odor is all that is necessary , and one application will usually suffice to protect an animal for five or six days .Another series of decidedly troublesome flies we find in the Anthomyiids , whose larvae are frequently root - infesting maggots . |
| source.excerpts.3.words.0 | odor |
| source.excerpts.3.words.1 | decided |
| source.excerpts.3.words.2 | of the crude acid |
| source.excerpts.4.@id | http://data.odeuropa.eu/source/573be5cb-75ea-5fd6-b98c-8ada37e3be9a/fragment/1df03541-8e6a-5ced-8e1d-2e9f36b40dbb |
| source.excerpts.4.value | THE INSECT WORLD .i6r offensive musky odor , which is quite lasting and noticeable even after stained hands have been thoroughly washed .We find the adult late in fall , and it remains in that condition during the winter , under bark of trees , under rubbish , in barns and similar localities . |
| source.excerpts.4.words.0 | odor |
| source.excerpts.4.words.1 | noticeable |
| source.excerpts.4.words.2 | offensive musky |
| source.excerpts.4.words.3 | quite lasting |
| source.excerpts.5.@id | http://data.odeuropa.eu/source/573be5cb-75ea-5fd6-b98c-8ada37e3be9a/fragment/27057144-46ef-5965-a747-43108d136360 |
| source.excerpts.5.value | Ordinarily the antennae are intended as tactile organs , â   that is , for touching , as the com - mon name â   feelerâ   indicates ; but it is very certain that other sensory structures are also located there .The perception of odors , or the sense of smell , is a very important function , and Piercing mouth structures of sucking lip is omitted .â   horse - fly â   : Much enlarged . |
...
| source.excerpts.13.words.1 | naphthalene |
...
| source.excerpts.20.words.0 | beetle |
...
| relevantExcerpt | http://data.odeuropa.eu/source/573be5cb-75ea-5fd6-b98c-8ada37e3be9a/fragment/7f4ce3d2-20d0-5ac0-ab48-23e5ebb3dda6 |
