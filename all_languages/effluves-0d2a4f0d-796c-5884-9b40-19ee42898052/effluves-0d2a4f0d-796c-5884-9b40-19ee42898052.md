...
| @id | http://data.odeuropa.eu/smell/0d2a4f0d-796c-5884-9b40-19ee42898052 |
| @graph | http://data.odeuropa.eu/gallica |
| label | effluves |
| source.@id | http://data.odeuropa.eu/source/6e6a9a6b-d357-52ba-95a4-50daf4648a58 |
| source.excerpts.0.@id | http://data.odeuropa.eu/source/6e6a9a6b-d357-52ba-95a4-50daf4648a58/fragment/016e6620-5287-52eb-a47c-a5c1809f9d83 |
| source.excerpts.0.value | Phénomène horrible et grandiose , sombre revers , qui révolte les sens , offense la raison comme un opprobre , et menace la vie par ses produits .De ces produits les plus subtils sont les miasmes de la putréfaction dont il nous restait à parler , et qui se distinguent en deux .classes , suivant que le corps en décomposition appartenait à l ' un ou à l ' autre des deux règnes vivants ; distinction qui s ' efface au plus bas de l ' échelle , où pullulent les infiniment petits , confondus dans la promiscuité de la corruption . |
| source.excerpts.0.words.0 | miasmes |
| source.excerpts.0.words.1 | putréfaction |
| source.excerpts.1.@id | http://data.odeuropa.eu/source/6e6a9a6b-d357-52ba-95a4-50daf4648a58/fragment/01fcb3c2-3e85-5fdd-9e2f-d31472a70cae |
| source.excerpts.1.value | Ces miasmes respires impunément , puis exhalés , seraient le moyen de transmission , ou l ' un des moyens de transmission par les personnes saines .Voudrait - on supposer que celles - ci ont puissance de les détruire ? Plût au ciel ! Mais détruiton les gaz fétides de la putréfaction respires dans les travaux an atomiques ? On sent bien que non .En somme , il nous est impossible malheureusement de ne pas admettre la trans - — 170 — missibilité du choléra par les personnes saines ; seulement il est permis d ' espérer que ce mode de transmission est le plus rare . |
| source.excerpts.1.words.0 | gaz |
| source.excerpts.1.words.1 | fétides |
| source.excerpts.1.words.2 | putréfaction |
| source.excerpts.2.@id | http://data.odeuropa.eu/source/6e6a9a6b-d357-52ba-95a4-50daf4648a58/fragment/10fa9c4d-497f-51ea-a098-fa35d0244281 |
| source.excerpts.2.value | Il est certain qu ' un grand nombre d ' entre eux vont s ' échouer sur la plage , ou restent embarrassés dans les chaînes des navires ; mais combien sont emportés par le courant dans la haute mer ! On sait aussi que les oiseaux de proie s ' en nourrissent presque exclusivement , et qu ' il leur faut peu de temps pour dépecer un cadavre entier .On ne peut disconvenir cependant qu ' ils no répandent des émanations putrides .Reste toujours à savoir si ces émanations recèlent la cause spécifique du choléra . |
| source.excerpts.2.words.0 | putrides |
| source.excerpts.2.words.1 | émanations |
| source.excerpts.3.@id | http://data.odeuropa.eu/source/6e6a9a6b-d357-52ba-95a4-50daf4648a58/fragment/16f3ebdb-a702-5cbf-aaf0-9fbf9741cdfd |
| source.excerpts.3.value | Les eaux de là Seine , qui reçoivent , au .niveau de Saint - Denis , le grand égout collecteur , furent littéralement infectées , ainsi que l ' atteste une plainte des riverains insérée dans le journal le Temps .En Angleterre , dans les fabriques de colle - forte , on traite par l ' acide phénique , à la dose de 2 ou 3 millièmes , les rognures de peaux et de tendons . |
| source.excerpts.3.words.0 | infectées |
| source.excerpts.3.words.1 | le grand égout |
| source.excerpts.3.words.2 | niveau de Saint - Denis |
| source.excerpts.4.@id | http://data.odeuropa.eu/source/6e6a9a6b-d357-52ba-95a4-50daf4648a58/fragment/17f74017-fe3f-5c63-b20e-6d5d6375d79c |
| source.excerpts.4.value | Mais , dans les deux cas suivants , l ' influence que nous étudions en ce moment , celle des objets ayant servi à des cholériques , apparaît nettement et distinctement .Dans le premier : « Il s ' agit d ' une femme qui , ayant emporté pour le laver à la rivière un paquet de linges souillés des déjections d ' un cholérique qui venait de succomber , se trouva mal à l ' odeur qu ' exhalaient ces linges à l ' ouverture du paquet , et bientôt après fut prise elle - même de la maladie , à laquelle elle succomba .« ( Bulletin de l ' Académie de médecine , t . |
| source.excerpts.4.words.0 | odeur |
| source.excerpts.4.words.1 | femme |
| source.excerpts.4.words.2 | linges |
| source.excerpts.4.words.3 | paquet |
| source.excerpts.4.words.4 | exhalaient |
| source.excerpts.4.words.5 | bientôt |
| source.excerpts.5.@id | http://data.odeuropa.eu/source/6e6a9a6b-d357-52ba-95a4-50daf4648a58/fragment/187c50d2-eada-5884-896c-99f804a19e1c |
| source.excerpts.5.value | > ? [ L ' Avenir , n ° du 14 novembre 1865 ; extrait de la Gazette officielle .) Heureusement , la Martinique et les autres Antilles flairèrent le choléra , rien qu ' à l ' odeur de la fièvre algide cholériforme , et se garantirent en imposant une quarantaine aux navires de la Guadeloupe .Quant aux îles dépendantes , Marie - Galante , la Désirade , les Saintes , qu ' il eût été aussi facile de préserver , elles furent livrées en pâture au fléau et décimées . |
