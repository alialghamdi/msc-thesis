...
| @id | http://data.odeuropa.eu/smell/9bed8069-7d47-5d25-9d79-26d66ee527cf |
| @graph | http://data.odeuropa.eu/gallica |
| label | odeurs |
| source.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c |
| source.excerpts.0.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/002e89c7-af70-5d02-b8f2-352d85e01823 |
| source.excerpts.0.value | Nous connaissons des personnes qui ont habituellement à l ' anus un suintement muqueux qui répand la même odeur .Nous pouvons comparer ce mucus particulier à celui que sécrètent le musc , la civette , ; la fouine ; c ' est bien à lui , chez ces anil maux , qu ' est due l ' odeur des excréments .A part de légères nuances d ' odeur , de ^ couleur et de consistance , les excréments sont identiques , de quelque aliment qu ' ils proviennent . |
| source.excerpts.0.words.0 | odeur |
| source.excerpts.0.words.1 | civette |
| source.excerpts.0.words.2 | musc |
| source.excerpts.0.words.3 | excréments |
| source.excerpts.1.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/06eae477-41ea-515a-8cd4-36bad11939ca |
| source.excerpts.1.value | Thénard croit être l ' acide acétique , et Berzéhus de l ' acide lactique .Mais cela ne suffit pas pour en faire une fonction différente , car s ' il en était ainsi , elle ne serait plus la même , non seulement chez les individus différents et dans les différents points de la surface du corps , où elle a une odeur et des qualités bien tran - chées , comme on le voit aux pieds , aux aisselles , etc ., mais encore dans la même partie , puisqu ' elle y varie d ' un instant à l ' autre de couleur , de saveur et d ' odeur . |
| source.excerpts.1.words.0 | odeur |
| source.excerpts.1.words.1 | elle |
| source.excerpts.2.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/06f803ad-1f26-5af9-a9a9-67638217965f |
| source.excerpts.2.value | sent distendre par l ' abord d ' une nouvell ( quantité de matière , et ainsi de suit ( jusqu ' à ce que tout ait passé .Pendant et trajet , le chyme se combine : 1 ° avec le suc intestinal , fluide provenant de la sécrétion folliculaire et de la perspiration des exhalants de l ' intestin ; une partie était formée d ' avance et en tapissait les parois ; l ' autre partie , plus abondante , n ' est sécrétée qu ' au moment du passage du chyme , qui , par son contact , excite ces nombreux sécréteurs , y appelle plus de sang et y détermine une véritable fluxion momentanée , qui fournit plus de matériaux , et par conséquent une sécrétion plus abondante .Il est bon dt dire que ce fluide favorise encore le glissement de la masse chymeuse en lu , brifiant les parois de l ' intestin ; 2 ° il se eombine avec la bile et le suc pancréatique , en partie versés dans le duodénum , étendus à sa surface et mêlés au suc intestinal ; mais la sécrétion de ces deux liquides est beaucoup plus abondante dans ce moment , soit parce que la vési - cule biliaire , qui s ' est remplie pendant la durée de l ' abstinence , se vide imcaniquement - par la pression qu ' exercent sur elle l ' estomac et le duodénum distendus , ou activement , par la stimulation qu ' elle reçoit de la présence des ali . |
| source.excerpts.2.words.0 | Pendant |
| source.excerpts.2.words.1 | exhalants |
| source.excerpts.3.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/087e0ffe-9840-5f3c-a27a-99ba25318650 |
| source.excerpts.3.value | ne puisse quelquefois être en défaut .Ainsi une bille unique nous paraît double quand nous la touchons d ' une certaine manière ; une pétale de rose placée entre deux doigts est inappréciable au toucher et ne manifeste sa présence qu ' à la vue et à l ' odorat ; l ' immersion simultanée ou successive des mains dans deux liquides d ' une égale température , mais d ' une nature différente , ferait croire ces liquides identiques , si la différence n ' était indiquée par d ' autres sens .— Ces exemples suffisent pour établir que le toucher employé seul est aussi sujet à fournir des notions incomplètes ou erronées . |
| source.excerpts.3.words.0 | odorat |
| source.excerpts.3.words.1 | liquides |
| source.excerpts.3.words.2 | pétale de rose |
| source.excerpts.4.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/0884d6ea-b3e0-5a97-b4d7-71c0b58e7be9 |
| source.excerpts.4.value | Lorsqu ' on approche ces substances du nez des personnes qui sont en syncope ou dans une crise histérique , et chez lesquelles la respiration ne s ' exécute pas du tout , l ' odeur qu ' elles répandent n ' en produit pas moins son effet , parce qu ' il suffit , pour que la sensation ait lieu , que les molécules odorantes arrivent à l ' organe .Or , les odeurs vivement expansibles vont toujours en s ' étendant de proche en proche à mesure qu ' elles saturent l ' air ambiant , et cette extension des molécules les fait pénétrer dans les fosses nasales , sans qu ' il soit besoin du renouvellement de l ' air dans ces cavités .— C ' est à la partie supérieure des fosses nasales que l ' olfaction a lieu . |
| source.excerpts.4.words.0 | odeurs |
| source.excerpts.4.words.1 | vivement expansibles |
| source.excerpts.5.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/098cb6ae-7395-536b-99f5-da69015d6939 |
| source.excerpts.5.value | Ce sont de tels faits qui ont fourni ample matière à la discussion et à l ' imagination .Dieu sait comme ici on a , fait jouer les effluves corporels , les esprits animaux , les fluides nerveux , les atmosphères magnétiques , l ' âme , etc .; comme on les a fait se dégager de leur enveloppe corporelle , pour aller à toutes les distances voir et entendre sans le secours des yeux ni des oreilles ! Toutes ces créations idéales sont le fruit tantôt d ' une imagination vive , enthousiaste et déréglée , tantôt du charlatanisme le plus déhonté . |
...
| source.excerpts.24.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/2f7d44ee-6e1e-51b0-9654-891beefdaf51 |
...
| source.excerpts.35.words.3 | sang |
...
| source.excerpts.56.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/7e87c1c1-e4b9-51e5-ad00-3939ac7da054 |
...
| source.excerpts.67.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/94ba7046-690a-577b-9b30-66e63892593c |
...
| source.excerpts.73.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/a8f465ae-d413-50e6-b92e-8fd6bce7bfa4 |
...
| source.excerpts.85.words.5 | depuis quelques instants |
...
| source.excerpts.89.words.4 | miasmes |
...
| source.excerpts.96.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/dc7f1daa-37d0-5ca8-8da1-31707c9dc673 |
| source.excerpts.96.value | Cette impression est .elle désagréable , les mâchoires paraissent se refuser à la mastication , la membrane buccale n ' est pas abreuvée par les glandes salivaires , les exhalants et les follicules muqueux ; le pharynx se resserre , et l ' estomac se soulève contre 1 » substance présentée .- L ' homme a primitivement l ' organe du goût moins parfait , moins exquis que la plupart deî animaux . |
| source.excerpts.96.words.0 | désagréable |
| source.excerpts.96.words.1 | follicules muqueux |
| source.excerpts.96.words.2 | exhalants |
| source.excerpts.96.words.3 | glandes salivaires |
| source.excerpts.96.words.4 | membrane buccale |
| source.excerpts.97.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/df2fc699-94ce-52fc-b92d-621e04a6bdd9 |
| source.excerpts.97.value | En traversant rapidement ces cavités , il produit un bruit particulier qui diffère un peu dans l ' un et l ' autre cas .Lorsque l ' air sort par les narines , il entraîne les mucosités et ses corps étrangers qui y sont engagés , et a les débarrassant , il rend la respiration lus libre et l ' odorat plus facile ; lorsqu ' il st expulsé par la bouche , il n ' opère sur ÎS fosses nasales qu ' une action seconaire de secousse qui ne chasse rien de t e qui les gêne , mais qui n ' en est pas moins avantageuse en faisant détacher ¡ lus facilement les mucosités qui y sont ntassées , et en les disposant à être aiséacnt entraînées par un autre éternument .— A ce mécanisme de la respira : ion dans l ' éternument , se joignent des actes accessoires très - importants . |
| source.excerpts.97.words.0 | odorat |
| source.excerpts.97.words.1 | narines |
| source.excerpts.97.words.2 | corps étrangers |
| source.excerpts.97.words.3 | mucosités |
| source.excerpts.97.words.4 | facile |
| source.excerpts.98.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/dff8ecd5-4c85-5343-abe8-cf4f0fad3dc3 |
| source.excerpts.98.value | Le tatouage nous semble en donner une preuve convaincante : fois qu ' une matière coIorante a été déposée dans le tissu , elle lest immuable et indélébile .— On trouve dans quelques animaux des sécrétions Iqui sont étrangères à l ' homme .Quoiqu ' il ine soit pas de notre sujet de nous en ocicuper ici , nous croyons cependant deivoir avertir que la fonction est toujours la même , quel que soit le produit . |
| source.excerpts.98.words | sécrétions |
| source.excerpts.99.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/e057fedb-fc78-5dd5-aaa3-5a2fbe33ca8e |
| source.excerpts.99.value | Nous pouvons dire la même chose de l ' ouïe .Quant au goût et à l ' odorat , il est plus facile de s ' assurer que l ' enfant jouit de suite de l ' usage de ces deux sens .Son intelligence paraît nulle encore , parce qu ' il n ' a aucune connaissance . |
| source.excerpts.99.words.0 | odorat |
| source.excerpts.99.words.1 | enfant |
| source.excerpts.100.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/e0955c9b-8338-50a6-8188-e403d3da5560 |
| source.excerpts.100.value | — De quelque vaisseau que le sang soit retiré , il est d ' un rouge plus ou moins foncé , et il répand une odeur sui generis , aura sangiunis , qui est propre à chaque ani - mal et que M .Barruel a trouvée semblable à l ' odeur de la sueur ; c ' est une émanation et non un gaz , comme Rosa et Moscati l ' avaient prétendu .D ' abord liquide , le sang se coagule plus ou moins vite en une masse homogène et mollasse , tjui se partage bientôt en une partie toutà - fait liquide , plus ou moins limpide et citrine y c ' est le sérum : et en une masse presque solide , rouge , spongieuse et d ' une forme variable : c ' est le caillot . |
| source.excerpts.100.words.0 | odeur |
| source.excerpts.100.words.1 | sueur |
| source.excerpts.100.words.2 | Barruel |
| source.excerpts.101.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/e2f1f1df-4d20-56d9-8911-cbeefb7f1b5f |
| source.excerpts.101.value | Aucune expérience ne peut venir nous éclairer .Mais si nous jugeons par analogie , nous penserons que ce mé - , lange des matériaux chylifères avec un liquide exhalé doit avoir lieu , parce que l ' aliment n ' éprouve ses changements successifs qu ' à mesure qu ' il se combine avec de nouveaux liquides .L ' analogie est complète . |
| source.excerpts.101.words.0 | liquide |
| source.excerpts.101.words.1 | exhalé |
| source.excerpts.101.words.2 | matériaux chylifères |
| source.excerpts.102.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/e4da5cd2-1adc-5667-988d-563e8f5f4cf6 |
| source.excerpts.102.value | De plus , quelques soustractions musculaires impriment à l ' orifice des narines un mouvement de dilatation et de resserrement bien sensible .Enfin , le passage de l ' air qui lui oppose les corpuscules odorants est déterminé par la respiration .— Nous retrouvons la même association dans l ' organe du goût : sécrétion des mucosités buccales et pharyngiennes , participation à la sensation générale , mouvement de la langue , du voile du palais et du pharynx , enfin coopération des organes qui lui apportent les corps sapides . |
| source.excerpts.102.words.0 | air |
| source.excerpts.102.words.1 | odorants |
| source.excerpts.103.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/eacacb3a-4d0f-588e-9937-6ed47a95d74b |
| source.excerpts.103.value | moyen de l ' air inspiré .La connaissance du renouvellement de l ' air dans les sinus , ne permet pas d ' admettre que ces cavités retiennent les odeurs et en prolongent l ' impression .D ' ailleurs les sinus sont nuls dans le . |
| source.excerpts.103.words.0 | odeurs |
| source.excerpts.103.words.1 | cavités |
| source.excerpts.104.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/ebd9f09a-f0b4-570e-996a-dc4945fca325 |
| source.excerpts.104.value | lations sympathiques de cette membrane .- L ' inspiration est une condition indispensable pour que les odeurs affectent la membrane olfactive .L ' incision de la trachée - artère interrompt l ' exercice du sens de l ' odorat , ainsi que Ferrant , Lower el Chaussier s ' en sont assurés . |
| source.excerpts.104.words.0 | odeurs |
| source.excerpts.104.words.1 | olfactive |
| source.excerpts.105.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/ed0d6b1f-f7fb-5b57-a784-1e1e90df6317 |
| source.excerpts.105.value | A ce mode d ' exhalation appartient celle du corpf yitré , qui est composé d ' un véritable tissu cellulaire ou lamineur , et d ' une humeur albumineuse , transparente et analogue à la synovie .3 ° Exhalation des membranes muqueuses .- A la surface librie des membranes muqueuses sont versées deux sortes de fluides , la sérosité et la mucosité . |
| source.excerpts.105.words.0 | membranes muqueuses |
| source.excerpts.105.words.1 | Exhalation |
| source.excerpts.106.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/eda98f82-7c2c-5cad-ad91-7718f1522eb5 |
| source.excerpts.106.value | On a rappelé la destination de la cin - i quième paire à fournir tous les nerfs desorganes des sens dans les animaux inférieurs .On a rappelé les trois observations de Méry , relatives à la conserva tion de l ' odorat malgré l ' état calleux du nerf o ! - I factif .— M . |
| source.excerpts.106.words.0 | odorat |
| source.excerpts.106.words.1 | Méry |
| source.excerpts.107.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/ee2c56c7-9361-5071-b373-e5f68cf50780 |
| source.excerpts.107.value | Quoiqu ' il ine soit pas de notre sujet de nous en ocicuper ici , nous croyons cependant deivoir avertir que la fonction est toujours la même , quel que soit le produit .Les hui ! es , les matières odorantes et colo ' rantes , les fluides textiles , lés poisons , lies gaz eux - mêmes , tous ces principes sont sécrétés de la même manière et reconnaissent ces mêmes lois .La production de l ' électricité et de la lumière dans ' certains animaux est encore soumise à ces lois . |
| source.excerpts.107.words.0 | matières |
| source.excerpts.107.words.1 | odorantes |
| source.excerpts.107.words.2 | hui |
| source.excerpts.107.words.3 | rantes |
| source.excerpts.107.words.4 | colo |
| source.excerpts.107.words.5 | fluides textiles |
| source.excerpts.107.words.6 | lies gaz |
| source.excerpts.107.words.7 | lés poisons |
| source.excerpts.108.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/f2fc4812-285e-5048-95e2-1bb0da690521 |
| source.excerpts.108.value | Aussi , lui , fut - il impossible de rien voir de ce qu ' on fit faire ensuite à la même personne qu ' elle venait de si bien voir .Il est encore vrai de dire que l ' odorat peut quelquerois suppléer la vue et faire annoncer la présence d ' une personne qu ' on ne voit réellement pas ; de la même manière qu ' un chien sent et reconnaît son maître sans le voir .C ' est ainsi que certains somnambules ont pu déciarer à qui appartenaient des vêtements ou d ' autres objets qui leur * étaient présentes , parce qu ' à l ' odeur ils avaient reconnu les émanations de la personne , comme ils auraient pu à la vue en reconnaître la forme . |
| source.excerpts.108.words.0 | odorat |
| source.excerpts.108.words.1 | chien |
| source.excerpts.109.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/f5325178-216b-5d9c-b534-a9eafa84afc7 |
| source.excerpts.109.value | — L ' exercice peut lui faire acquérir une grande perfection , comme le prouve ' exemple des parfumeurs .L abus des substances fortement odorantes , du tajac , par exemple , finit à la longue par ; létruire sa finesse .Celle - ci devient plus i rande par la perte de la vue ou de i ' ouïe , pourvu que cette infirmité tienne ■ ■ i des conditions locales . |
| source.excerpts.109.words.0 | odorantes |
| source.excerpts.109.words.1 | substances |
| source.excerpts.109.words.2 | fortement odorantes |
| source.excerpts.109.words.3 | tajac |
| source.excerpts.110.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/f57baf33-9fc3-5606-899c-4964cad5be90 |
| source.excerpts.110.value | Jusque - là ce n ' est qu ' un a t incontestable ; mais lorsqu ' on veut ) énétrer daps l ' intimité de ce qui se passe le molécule à molécule , là commence ' obscurité , et naissent les difficultés sans nombre , qui , en couvrant ce phénomène ' l ' un voile mystérieux , ont ouvert une • bro carrière à l ' imagination et ont fait enfanter toutes les hypothèses .On conçoit que la composition de l ' air ayant elle - mème donné des résultats différents aux analyses chimiques , il ait été facile de s ' égarer , lorsqu ' il a fallu apprécier les éléments qu ' il cédait et ceux qu ' il acquérait , lorsque la variation qu ' ils présentent ne permet pas d ' être d ' accord à leur égard , lorsque surtout on ne sait pas même encore s ' il y a ou non de l ' azote absorbé ou exhalé , puisque MM .Despretz , Humboldt et Provençal pensent qu ' il s ' en exhale toujours , tandis que M . |
| source.excerpts.110.words.0 | air |
| source.excerpts.110.words.1 | exhalé |
| source.excerpts.111.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/f6753401-88e6-5d1a-afd7-c2d4dbe04d03 |
| source.excerpts.111.value | L ' absorption des fluides gazeux ou vaporeux n ' est pas plus douteuse .En respirant pendant quelques instants l ' odeur de la térébenthine , du camphre , de l ' encens , les urines prennent l ' odeur de la violette .En respirant les vapeurs opiacées , on produit le calme de douleurs éloignées et souvent le narcotisme . |
| source.excerpts.111.words.0 | odeur |
| source.excerpts.111.words.1 | violette |
| source.excerpts.111.words.2 | encens |
| source.excerpts.111.words.3 | camphre |
| source.excerpts.111.words.4 | térébenthine |
| source.excerpts.111.words.5 | urines |
| source.excerpts.111.words.6 | pendant |
| source.excerpts.111.words.7 | pendant quelques instants |
| source.excerpts.112.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/fbead3c8-fe71-5ad6-9c89-090514f3345a |
| source.excerpts.112.value | Elle n ' existe réellement qu ' à leur surface , et ce qui le prouve , c ' est que la partie centrale en est presque entièrement dépourvue .Nous connaissons des personnes qui ont habituellement à l ' anus un suintement muqueux qui répand la même odeur .Nous pouvons comparer ce mucus particulier à celui que sécrètent le musc , la civette , ; la fouine ; c ' est bien à lui , chez ces anil maux , qu ' est due l ' odeur des excréments . |
| source.excerpts.112.words.0 | odeur |
| source.excerpts.112.words.1 | personnes |
| source.excerpts.112.words.2 | Nous |
| source.excerpts.112.words.3 | suintement muqueux |
| source.excerpts.113.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/fed9e6bd-6044-5e2b-9ade-94c660146de5 |
| source.excerpts.113.value | On sent combien sa quantité plus ou moins considérable devra les faire varier , en rendant la digestion plus ou moins prompte , la chymification plus ou moins complète , et l ' absorption plus ou moins grande .Qui ne connaît la qualité que prennent les fèces chez les personnes qui , ayant une maladie du foie , ne fournissent plus une quantité suffisante de bile ? Assez or / linairement cette évacuation est accompagnée de la sortie plus ou moins bruyante d ' une quantité indéterminée de gaz , tantôt inodore , tantôt et le plus souvent caractérisé par l ' odeur du gaz acide hydro - sulfurique .Quelquefois ce gaz s ' est dégagé des matières pendant leur séjour dans l ' intestin . |
| source.excerpts.113.words.0 | odeur |
| source.excerpts.113.words.1 | gaz acide hydro - sulfurique |
| source.excerpts.114.@id | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/ff65301c-dee8-5ac6-b869-9f3a62fb91d2 |
| source.excerpts.114.value | souvent mise à profit pour ranimer l ' action des centres de vitalité ; elle paraît plutôt que l ' absorption avoir suppléé aux effets réparateurs d ' une nourriture solide pour cet homme qui , suivant Bacon , .vivait trois , quatre et cinq jours sans aliments , ni boissons , au moyen d ' un mélange d ' herbes dont il sentait l ' odeur et auquel il ajoutait de l ' ail , des oignons et autres substances fortement odorantes .Considérations générales sur les sens . |
| source.excerpts.114.words.0 | odeur |
| source.excerpts.114.words.1 | odorantes |
| source.excerpts.114.words.2 | fortement |
| source.excerpts.114.words.3 | herbes |
| source.excerpts.114.words.4 | substances |
| source.excerpts.114.words.5 | ail |
| source.excerpts.114.words.6 | oignons |
| source.excerpts.114.words.7 | mélange |
| source.author.0.@id | http://data.odeuropa.eu/actor/34065ec5-b313-526f-b235-bfa3a1adb0ef |
| source.author.0.label | Fouilhoux |
| source.label | Encyclopédie des sciences médicales. t. 5, Physiologie / par MM. Brachet et Fouilhoux,... |
| source.url | https://gallica.bnf.fr/ark:/12148/bpt6k9714039w |
| source.date | 1835 |
| source.language | fr |
...
| relevantExcerpt | http://data.odeuropa.eu/source/8f6564ff-fc51-5e27-926c-a98c64857f5c/fragment/79fc381b-d11c-5c05-8017-35b05755ec8a |
| license | Public domain |
| adjective | inaperçues |
