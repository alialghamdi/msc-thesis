...
| @id | http://data.odeuropa.eu/smell/08d3ab89-afcf-53e6-94d0-598ff27da8d7 |
| @graph | http://data.odeuropa.eu/wikisource |
| label | smell |
| source.@id | http://data.odeuropa.eu/source/da22cf80-cc27-5af7-8144-46fcff2a8a14 |
| source.excerpts.0.@id | http://data.odeuropa.eu/source/da22cf80-cc27-5af7-8144-46fcff2a8a14/fragment/14b1cd2b-0705-5f57-915f-5662766f588f |
| source.excerpts.0.value | The period of the hot winds , called the khamsin , that is , “ the fifties , ” is calculated from the day after the Coptic Easter , and terminates on the day of Pentecost , and the Moslems observe the Wednesday preceding this period , called “ Job ’ s Wednesday , ” as well as its first day , when many go into the country from Cairo , “ to smell the air .” This day is hence called Shem en - Nesim , or “ the smelling of the zephyr .” The Ulema observe the same custom on the first three days of the spring quarter . |
| source.excerpts.0.words.0 | smelling |
| source.excerpts.0.words.1 | Nesim |
| source.excerpts.0.words.2 | of the zephyr |
| source.excerpts.1.@id | http://data.odeuropa.eu/source/da22cf80-cc27-5af7-8144-46fcff2a8a14/fragment/174b90ee-aaec-5c39-9f25-de91fe7e22f1 |
| source.excerpts.1.value | The genus , from the evidence of leaf - remains , appears to have been represented by several species in Eocene times .The leaves are leathery in texture , hang obliquely or vertically , and are studded with glands which contain a fragrant volatile oil .The petals cohere to form a cap which is discarded when the flower expands . |
| source.excerpts.1.words.0 | fragrant |
| source.excerpts.1.words.1 | volatile oil |
| source.excerpts.2.@id | http://data.odeuropa.eu/source/da22cf80-cc27-5af7-8144-46fcff2a8a14/fragment/22bb59e9-226d-58a2-a43d-97d37331055f |
| source.excerpts.2.value | P .Boudet ( 1778 – 1849 ) embalmed with tan , salt , asphalt and Peruvian bark , camphor , cinnamon and other aromatics and corrosive sublimate .The last - mentioned drug , chloride and sulphate of zinc , acetate and sulphate of alumina , and creasote and carbolic acid have all been recommended by various modern embalmers . |
| source.excerpts.2.words.0 | camphor |
| source.excerpts.2.words.1 | cinnamon |
| source.excerpts.2.words.2 | aromatics |
| source.excerpts.2.words.3 | asphalt |
| source.excerpts.3.@id | http://data.odeuropa.eu/source/da22cf80-cc27-5af7-8144-46fcff2a8a14/fragment/23c98007-7862-5dff-af75-c6a1ac724811 |
| source.excerpts.3.value | This constituent is the alkaloid cornutine , which is the valuable ingredient of the drug .Other ingredients are a fixed oil , present to the extent of 30 % , ergotinic acid , a glucoside , trimethylamine , which gives the drug its unpleasant odour , and sphacelinic acid , a non - nitrogenous resinoid body .Of the numerous preparations only two need be mentioned — the liquid extract ( dose 10 minims to 2 drachms or more ) , and the hypodermic injection . |
| source.excerpts.3.words.0 | trimethylamine |
| source.excerpts.3.words.1 | odour |
| source.excerpts.3.words.2 | unpleasant |
| source.excerpts.3.words.3 | drug |
| source.excerpts.3.words.4 | glucoside |
| source.excerpts.4.@id | http://data.odeuropa.eu/source/da22cf80-cc27-5af7-8144-46fcff2a8a14/fragment/2a72f225-5b6c-518a-86e3-cd15c20cfd9f |
| source.excerpts.4.value | But the trimness of her plots and the delicacy of her miniature work have affinities in Maria Edgeworth , Harriet Martineau and Mary Russell Mitford , three excellent writers of pure English prose .There is a finer aroma of style in the contemporary “ novels ” of Thomas Love Peacock ( 1785 – 1866 ) .These , however , are rather tournaments of talk than novels proper , releasing a flood of satiric portraiture upon the idealism of the day — difficult to be apprehended in perfection save by professed students . |
| source.excerpts.4.words.0 | aroma |
| source.excerpts.4.words.1 | finer |
| source.excerpts.4.words.2 | of style |
| source.excerpts.5.@id | http://data.odeuropa.eu/source/da22cf80-cc27-5af7-8144-46fcff2a8a14/fragment/2ca33f79-124a-502c-b484-687f289f695d |
| source.excerpts.5.value | argot , a cock ’ s spur ) , which are violet - black or dark - purple externally , and whitish with a tinge of pink within , are between 1 / { { { 1 } } } and 11 / { { { 1 } } } in .long , and from 1 to 4 lines broad , and have two lateral furrows , a close fracture , a disagreeable rancid taste , and a faint , fishy odour , which last becomes more perceptible when the powder of the drug is mixed with potash solution .Ergot should be kept in stoppered bottles in order to preserve it from the attacks of a species of mite , and to prevent the oxidation of its fatty oil . |
...
| source.excerpts.11.words.2 | of , fish |
...
| source.excerpts.17.words.3 | colours |
