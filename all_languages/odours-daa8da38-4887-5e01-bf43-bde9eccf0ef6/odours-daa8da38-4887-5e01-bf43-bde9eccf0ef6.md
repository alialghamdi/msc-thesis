...
| @id | http://data.odeuropa.eu/smell/daa8da38-4887-5e01-bf43-bde9eccf0ef6 |
| @graph | http://data.odeuropa.eu/medical-heritage |
| label | odours |
| source.@id | http://data.odeuropa.eu/source/a974a6eb-e948-5fa5-9e58-8ef1c20d7d1c |
| source.excerpts.0.@id | http://data.odeuropa.eu/source/a974a6eb-e948-5fa5-9e58-8ef1c20d7d1c/fragment/0388b56f-cfc1-58ed-ba43-15bd93ff5576 |
| source.excerpts.0.value | 18 , with which the last ( iron ) trap may be compared , serves to illustrate a cheap description of trap that may be found suitable where traffic of a heavy character may not exist , or where relief from surface water is required by the side of carriage drives , & c .It should be understood , how - ever , that all these traps require frequent emptying , and that in continued dry weather they require to be furnished with water , or stench escaping from the sewer will be perceptible .To prevent gases generated in a public sewer or cesspool from E 2 52 EXTERNAL SEWERAGE . |
| source.excerpts.0.words.0 | perceptible |
| source.excerpts.0.words.1 | stench |
| source.excerpts.0.words.2 | from the sewer |
| source.excerpts.1.@id | http://data.odeuropa.eu/source/a974a6eb-e948-5fa5-9e58-8ef1c20d7d1c/fragment/0b7f9c11-4096-5411-9d5e-8cd06d3a3de6 |
| source.excerpts.1.value | Much , however , can be done to alleviate this objectionable state by outlets through the kitchen ceiling connected with tubes laid between the ceiling and the floor immediately above , which should communicate with the open air ; by the judicious situation of doors and window in relation to the fire place ; and by the selection of northern or eastern aspect where possible .In country houses where these evils are almost invariably preventible disagreeable kitchen odours , nevertheless , are frequently as perceptible as in town houses .In the country no living or sleeping rooms should exist over these essential offices , but they should be separate , though attached , with space between ceiling and Toof sufficient to allow of the gradual though certain escape of steam and vapours by proper ventilating arrangements made more perfect by the association of an empty f ! ue connected with the chimneys ; and the provision of properly devised doors to separate these offices from the main portion of the dwelling . |
| source.excerpts.1.words.0 | odours |
| source.excerpts.1.words.1 | In country houses |
| source.excerpts.1.words.2 | as perceptible |
| source.excerpts.1.words.3 | preventible disagreeable kitchen |
| source.excerpts.2.@id | http://data.odeuropa.eu/source/a974a6eb-e948-5fa5-9e58-8ef1c20d7d1c/fragment/2b760a4f-c034-50b4-80b3-ad92f29d4f31 |
| source.excerpts.2.value | in the ground in the neighbourhood of sewers , and render it , to use the words of Mr .Simon , " excrement - sodden , " and the air excrement - reeking ." This is evidently the case in several of our sea - board towns , where the sewage is retained in the sewers by the rising of the tide , and which are thus converted into cess - pools . |
| source.excerpts.2.words.0 | excrement |
| source.excerpts.2.words.1 | reeking |
| source.excerpts.2.words.2 | the air excrement |
| source.excerpts.3.@id | http://data.odeuropa.eu/source/a974a6eb-e948-5fa5-9e58-8ef1c20d7d1c/fragment/4c8e81c4-3def-50ca-8c7e-e3b58f8b9c52 |
| source.excerpts.3.value | Two important objects should be aimed at wherever water - closets are used , ( i .) They should be so placed that no objection - able smell shall find its way into the other parts of the dwelling when they are used .( 2 . |
| source.excerpts.3.words.0 | smell |
| source.excerpts.3.words.1 | able |
| source.excerpts.3.words.2 | objection |
| source.excerpts.3.words.3 | into the other parts of the dwelling |
| source.excerpts.4.@id | http://data.odeuropa.eu/source/a974a6eb-e948-5fa5-9e58-8ef1c20d7d1c/fragment/6d175d0a-7511-5fa8-8feb-d124c7e67244 |
| source.excerpts.4.value | To effect the first - named object , all water - closets should be constructed against external walls with a means of direct open air ventilation â   not necessarily by open windows â   and there should be in addition , wherever it can be so arranged , a lobby , ante - room , or passage provided with a like means of ventilation , and a second door cutting this lobby or apartment off from the interior of the dwelling .But it very often happens that the effect of this arrange - ment when imperfectly carried out is far from satisfactory , inas - much as the colder air admitted from without drives forward the warmer odour which the lobby is intended to arrest .In many instances water - closets constructed in the centre of dwellings ( as in the Metropolis and other towns ) are free from S8 INTERNAL SEWERAGE . |
| source.excerpts.4.words.0 | the |
| source.excerpts.4.words.1 | odour |
| source.excerpts.4.words.2 | warmer |
| source.excerpts.5.@id | http://data.odeuropa.eu/source/a974a6eb-e948-5fa5-9e58-8ef1c20d7d1c/fragment/8b46ebd0-0f64-5afb-a5a5-0255dd3cc08e |
| source.excerpts.5.value | stly , as it is discharged to the sea after it has assumed the form of rivers and tributary streams .In its condition as vapour and as rain , water is defiled by the gases of putrefying organic matters , which rise into the air from the surface of the earth , while as dew and hoar - frost it is * Hydrogen is a colourless , tastelessness , and inodorous gas , 14J times lighter than atmospheric air .It is very inflammable , and burns in air with a pale flame , producing water by combining with atmospheric oxygen . |
...
| source.author.0.@id | http://data.odeuropa.eu/actor/e22f5fdd-792f-587e-bc63-2c82a613fc41 |
