...
| @id | http://data.odeuropa.eu/smell/e1c579b7-cce8-58cf-b484-ffa04cf94810 |
| @graph | http://data.odeuropa.eu/gallica |
| label | senteurs |
| source.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0 |
| source.excerpts.0.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/03fdafcb-5067-5aa0-8172-e7347a16c101 |
| source.excerpts.0.value | Les E < MM Les eaux de Pullua sont fournies par dix sources qui émergent dans des puits profonds creusés dans une plaine de formation tertiaire , environnée de montagnes volcaniques .L ' eau de ces fontaines , dont la température est de 7 degrés centigrades , est identique sous le rapport de tous ses caractères physiques et chimiques ; limpide et transparente matgré sa teinte jaune - verdàtre , elle est sans odeur et d ' une saveur à la fois saline et amère , assez désagréable .Celle eau sulfatée sodique et tna ~ ~ t ~ Mnc renferme , d ' après t ' analyse de Struv , les éléments constitutifs suivants K < u = ~ . |
| source.excerpts.0.words.0 | sans |
| source.excerpts.0.words.1 | odeur |
| source.excerpts.0.words.2 | elle |
| source.excerpts.0.words.3 | assez désagréable |
| source.excerpts.0.words.4 | eau de ces fontaines |
| source.excerpts.1.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/05a62419-181f-545c-8dc3-0c7a23f55ac4 |
| source.excerpts.1.value | pendant l ' hiver ) , se compose de deux rangées de maisons qui hordent sa seule et unique rue ; il occupe une situation des plus pittoresques et des plus charmantes au milieu des grands bois dont sont recouverts tous les versants des Karpathes .Cette région où l ' air de l ' atmosphère est pur et tout imprégné de senteurs ba ) s : ( miques , possède , comme le prouve la végétation luxuriante du sol , un climat chaud : néanmoins les brises qui s ' échangent entre les vattécs et les montagnes donnent aux matinées et aux soirées des jours d ' été une fratcheur des plus agréables .E < « m « ement * thefmtmx . |
| source.excerpts.1.words.0 | senteurs |
| source.excerpts.1.words.1 | région |
| source.excerpts.1.words.2 | s |
| source.excerpts.2.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/06ebda41-28c7-57e5-8a36-a041e044cd3e |
| source.excerpts.2.value | Ainsi l ' eau de l ' Herculsbrunnen est limpide , sans odeur , à saveur amère et satee ; celle de la Cartsbrunnen est au contraire légèrement trouble avec des corpuscules floconneux en suspension , d ' une odeur hépatique et d ' une saveur tout à la fois salée et sulfureuse .L ' eau des autres sources est plus ou moins limpide , d ' un goût sulfureux et salé , d ' une odeur nettement sulfureuse .La Francisbrunnen dépose , au contact de l ' air atmosphérique , un sédiment blanchâtre . |
| source.excerpts.2.words.0 | odeur |
| source.excerpts.2.words.1 | sulfureux |
| source.excerpts.2.words.2 | goût |
| source.excerpts.2.words.3 | nettement sulfureuse |
| source.excerpts.2.words.4 | eau des autres sources |
| source.excerpts.3.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/0abcb884-9661-52f9-98b6-692e395395ef |
| source.excerpts.3.value | et le débit de 108 hectolitres par vingt - quatre heures .Claire , transparente et limpide au griffon , l ' eau de cette source forme dans son bassin un dépôt grisâtre qui parfois est couvert d ' atgnes microscopiques d ' un rose brillant ( sulfararia , getatinosa et chromatium ) ; son odeur et sa saveur sont sensiblement hépatiques .Analysée en 1816 par le professeur Fellenberg et en 1873 par M . |
| source.excerpts.3.words.0 | odeur |
| source.excerpts.3.words.1 | eau de cette source |
| source.excerpts.3.words.2 | sensiblement hépatiques |
| source.excerpts.3.words.3 | sulfararia |
| source.excerpts.4.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/0b2e2344-e09e-5927-bdde-cb9d3989c729 |
| source.excerpts.4.value | L ' eau du Rakoczy , dont la température d ' émergence est de 10 ° , 75 C ., et le débit de 538 hectolitres par vingt - quatre heures ( Batting ) , n ' est pas très limpide ; troublée par de nombreuses bulles de gaz et par des paillettes rougpatres qu ' elle tient en suspension , elle a un reflet chatoyant et bleuâtre elle possède une odeur piquante d ' acide carbonique et une saveur acidulée , salée et surtout ferrugineuse qui varie par les temps d ' orage , par les grands vents ou avec les grandes eaux c ' est ainsi que son goût change d ' un jour à l ' autre , et que c ' est tantôt l ' acide et tantôt le sel ou le fer qui y prédominent .Plus limpide que cette dernière , l ' eau du Pandur laisse néanmoins déposer sur les parois de son bassin un sédiment ocracé ; sa température native est de 10 * , 7 C . |
...
| source.excerpts.15.words.2 | drèche |
...
| source.excerpts.22.value | d ' un calcaire compact de couleur noirâtre .Ses eaux claires , transparentes et limpides , sont inodores et insipides ; leur masse est traversée par des bulles gazeuses qui gagnent toHement la surface .La source de Weissenburg possède , d ' après l ' analyse de Stierlin ( i87S ) , la composition élémentaire suivante Han = i . |
...
| source.excerpts.28.words.2 | Leurs |
...
| source.excerpts.45.words.0 | sudorifique |
...
| source.excerpts.57.value | Les eaux du Fured sont froides , bicarbonatées calciques , ferrugineuses et Mr ~ oHt ~ MM ~ M ' ( ~ .Limpides , claires et transparentes , elles ont une odeur piquante et une saveur fraîche , acidule et chalybée tout à la fois ; traversées sans cesse par de nombreuses et grosses bulles de gaz qui viennent s ' épanouir à lasurface , elles abandonnent un dépôt ocreux sur les parois intérieures des bassins de captage .Nous rapportots ici l ' analyse de la source de la Buvette ou de François - Joseph dont la température est de i2 ° , 8 C . |
...
| source.excerpts.68.words.1 | piquante |
...
| source.excerpts.79.words.1 | marécageuse |
...
| source.excerpts.86.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/dba5048a-4dac-5b79-a0b3-08a1c5feac43 |
...
| source.excerpts.92.words.3 | gaz |
...
| source.excerpts.94.value | L ' homme préhistorique , dans ses migrations , soit en famille , soit en tribu , n ' avait comme route possible que le cours des fleuves et leurs vattées il devait donc nécessairement rencontrer sur son passage les sources minérales qui presque toutes jaillissent sur le bord des rivières on à la base des montagnes .Par leur thermatité , leur odeur , leur aspect , leur saveur et par leurs dépôts de couleurs diverses et de formes parfois fantastiques , ces eaux n " pouvaient manquer d ' exciter la curiosité de cet homme primitif poussé par son merveilleux instinct d ' observation , il a dû s ' arrêter à ces fontaines et leur demander le secret de leurs vertus .Il n ' est point téméraire d ' affirmer que , dans la auite des temps , des peuplades jusqu ' alors nomades se sont fixées , en raison des avantages qu ' elles y trouvaient , t sur le territoire des sources salines ou thermales fai < blement minéralisées , répondant si bien aux nécessités journalières de la vie matérielle . |
| source.excerpts.94.words.0 | odeur |
| source.excerpts.94.words.1 | leur |
| source.excerpts.94.words.2 | ces eaux |
| source.excerpts.94.words.3 | fontaines |
| source.excerpts.94.words.4 | homme |
| source.excerpts.94.words.5 | saveur |
| source.excerpts.95.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/ed5d34b8-1a92-5cf0-8157-b31f7647ef42 |
| source.excerpts.95.value | Van KerkhoC ( 1848 ) , les principes élémentaires suivants Etn = 1 .Constipante à faible dose et purgative à dose élevée , l ' eau chlorurée sodique et ~ ' omo - todtn ' ~ de Mondorf est , comme ses congénères , analeptique , tonique et reconstituante .Non diurétique et sans action marquée sur le système nerveux , elle agit sur la circulation générale d ' une façon différente , suivant son administration interne ou externe c ' est ainsi que , prise en boisson , elle excite la circulation du sang , tandis que les bains la ralentissent , au contraire . |
| source.excerpts.95.words.0 | analeptique |
| source.excerpts.95.words.1 | eau chlorurée sodique |
| source.excerpts.96.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/edc03020-17be-589d-9504-12c8625aa0fa |
| source.excerpts.96.value | Les eaux des trois dernières sources servent à l ' alimentation des bains et des douches , tandis que celles des trois premières sont exclusivement réservées à la boisson .L ' eau de toutes ces sources est claire , limpide et pétillante la source de Constantin a une saveur acidule et piquante avec arrière - goût satin les eaux de la Johannisquelle et de la Klausnersquelle ont au contraire un goût styptique et ferrugineux .Nous rapporterons ici la composition des deux sources les plus minéralisées de cette station EtM = i . |
| source.excerpts.96.words.0 | eaux |
| source.excerpts.96.words.1 | goût |
| source.excerpts.96.words.2 | saveur |
| source.excerpts.96.words.3 | eau de toutes ces sources |
| source.excerpts.96.words.4 | source de Constantin |
| source.excerpts.97.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/ee9c3bbd-fc88-5d37-ae9f-2dabb9ae94eb |
| source.excerpts.97.value | De l ' Erdfall , des sentiers conrant à travers des jardins et des bosquets conduisent au château de Liebenstein ( t kilomètre ) , dont la construction remonte aux premières années du xn * siècle .Le climat de ! a vallée de Lowera , où l ' atmosphère est imprégnée de senteurs balsamiques , grâce au voisinage de la forêt de Rôn , est d ' une assez grande douceur ; toutefois , les matinées et tes soirées sont généralement assez tratches .ËtmMt * * e ) ttent thermal . |
| source.excerpts.97.words.0 | atmosphère |
| source.excerpts.97.words.1 | senteurs |
| source.excerpts.97.words.2 | forêt de Rôn |
| source.excerpts.97.words.3 | vallée de Lowera |
| source.excerpts.98.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/f1a13633-e6ad-54b3-8bf7-30ca61435aa2 |
| source.excerpts.98.value | - L ' Etablissement thermal , entouré do magnifiques jardins , possède une installation très complète ; il t ' enferme 150 chambres confortablement meublées , 40 cabinets de bains , des douches de toute forme et de tout calibre , des bains de vapeur et des appareils à gaz carbonique et enfin une Trinkhalle ou buvette .A ces ressources hydrominérales il faut joindre le petit - lait et les inhalations de bourgeons de sapin .t « ) ) t JE ~ mx . |
| source.excerpts.98.words.0 | bourgeons de sapin |
| source.excerpts.98.words.1 | inhalations |
| source.excerpts.99.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/f1c58820-557d-540f-aca5-1e00608618e8 |
| source.excerpts.99.value | Leur eau , d ' un poids spécifique de t , 01i2 , est claire et transparente aux griffons ; mais elle perd bientôt sa limpidité au contact de l ' air et de la lumière elle prend alors une couteur rappelant celle de l ' eau de mer et dépose après s ' être troublée un abondant précipité qui devient noir .D ' une odeur très sulfureuse ., surtout par les temps orageux , cette eau , d ' une réaction absolument neutre , ne laisse dégager aucune bulle de gaz et possède une saveur âcre , hépatique et salée tout à la fois . |
| source.excerpts.99.words.0 | odeur |
| source.excerpts.99.words.1 | très sulfureuse |
| source.excerpts.100.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/f1eac117-cabc-55a3-bd0a-a34242c5ce20 |
| source.excerpts.100.value | On appelle souvent Bilin le Vichy froid en effet , par leur composit ' ott , les eaux minérales de Bilin se rapprochent assez des eaux de Vichy .Leur saveur piquante , leur grande limpidité et leur métange facile avec le vin en ont fait une eau de table qui se consomme aujourd ' hui dans toutes les parties de i ' Aitemagne elles sont transportées dans des cruchons où elles se conservent longtemps .On utilise presque exclusivement l ' eau de la Josephsquelle pour cette exportation qui est considérable les eaux des autres sources , grâce à leur abondance , servent à la fabrication des sels de soude et de magnésie , dits sels po ~ c / tt M < ~ de Bilin . |
| source.excerpts.100.words.0 | piquante |
| source.excerpts.100.words.1 | saveur |
| source.excerpts.100.words.2 | Aitemagne |
| source.excerpts.101.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/f454c101-fbb3-5796-a826-8dfc0e6f3573 |
| source.excerpts.101.value | Des maisons se groupèrent bientôt autour de ce château fort elles formèrent le noyau de la nouvelle ville qui s ' étend aujourd ' hui sur les bords de la Limmat et dans une étroite vallée enserrée dans des montagnes couvertes d ' arbres verts , de la base au sommet .Sise à 547 mètres au - dessus du niveau de la mer , au milieu d ' une région montagneuse des plus admirables , la vattée de Baden est abritée contre tous tes vents ; son atmosphère , très pure et imprégnée de senteurs balsamiques , augmente pour les malades tes avantages de son climat , aussi remarquable par sa douceur que par son égatité .La température moyenne de l ' été n ' est que de M ' , 6 G . |
| source.excerpts.101.words.0 | atmosphère |
| source.excerpts.101.words.1 | senteurs |
| source.excerpts.101.words.2 | malades |
| source.excerpts.101.words.3 | vattée de Baden |
| source.excerpts.102.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/f5095d37-0a76-54a9-9b2a-8622550f3de3 |
| source.excerpts.102.value | La quatrième source n ' est point utilisée .L ' eau de ces diverses sources présente dans ses caractères physiques la plus grande analogie ; claire , transparente , limpide et inodore , elle possède une saveur piquante , acidulée etstyptique ; pétittante dans les verres eu raison de t ' acidc carbonique qui s ' échappe de toute sa masse , elle devient légèrement opaline par son exposition a t ' air et abandonne dans ses tuyaux de conduite un dépôt ocracé .La Vieille Source et ta - Source Nouvelle ou de Paracelse renferment , d ' après l ' analyse de Husemann ( 1874 ) , les principes élémentaires suivants KM = t . |
| source.excerpts.102.words.0 | elle |
| source.excerpts.102.words.1 | saveur |
| source.excerpts.102.words.2 | eau de ces diverses sources |
| source.excerpts.103.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/f8fd4448-8d51-5f62-9b02-0c0b5e91892a |
| source.excerpts.103.value | Les sources Saint - Ho ! ) itaee , Saint - Ours , Charlotte , Saint - Ftorin et ( ~ n ) j ' hett se distinguent des précédentes par leur saveur plus fraîche , plus agréable et en même temps plus ferrugineuse .Hnnn les eaux suffm ' euses , qui sont claires , transparentes et limpides , se révèlent par leur odeur hépatique fortement accusée .Voici , d ' après les analyses de de Planta , la composition < j ) é ) t ) entaire des sources chlorurées , ferrugineuses et sul / < fre ) ( Sfs de Tarasp - Schuts K . |
| source.excerpts.103.words.0 | odeur |
| source.excerpts.103.words.1 | leur |
| source.excerpts.103.words.2 | hépatique fortement accusée |
| source.excerpts.103.words.3 | eaux suffm ' euses |
| source.excerpts.104.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/fc7ba810-7fef-58a7-a4ec-54c211a6c9f2 |
| source.excerpts.104.value | Si l ' on excepte la température , les caractères physiques et chimiques de toutes les sources sont identiques a cette de la Hauptquette .L ' eau de cette fontaine est claire , limpide et inodore ; sa saveur légèrement salée , sans être désagréable , se rapproche de celle d ' un bouitton très salé .Elle laisse déposer dans la source des statactites formées de sulfates et de carbonate de fer et de chaux , ainsi qu ' un limon de couleur brune . |
| source.excerpts.104.words.0 | désagréable |
| source.excerpts.104.words.1 | saveur |
| source.excerpts.104.words.2 | légèrement salée |
| source.excerpts.104.words.3 | eau de cette fontaine |
| source.excerpts.104.words.4 | bouitton |
| source.excerpts.105.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/fcbd8a87-0be0-53ce-ac90-c684e210126c |
| source.excerpts.105.value | jaune et verdâtre dans le bassin de déversement ainsi que dans ses réservoirs où elle dépose un sédiment ocracé .Sans odeur caractéristique et d ' une saveur fraîche et saline non désagréable au premier abord , elle cause bientôt une sensation de sécheresse à la bouche .On a observé qu ' à certaines époques indéterminées et surtout après les orages , cette eau perdait momentanément sa teinte jaunâtre pour reprendre dans les bassins sa limpidité origineHe . |
| source.excerpts.105.words.0 | odeur |
| source.excerpts.105.words.1 | elle |
| source.excerpts.105.words.2 | caractéristique |
| source.excerpts.106.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/fcd6c991-03c9-5704-b359-8e8b012e32a2 |
| source.excerpts.106.value | elles ne diffèrent entre elles que par la différence quantitative de leurs mêmes principes minéralisateurs .Claire , transparente et limpide , leur eau très gazeuse possède une saveur piquante , acidule et légèrement styptique .Le goût de la source Léopold est faiblement hépatique . |
| source.excerpts.106.words.0 | saveur |
| source.excerpts.106.words.1 | leur eau |
| source.excerpts.107.@id | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/fed535aa-752d-565f-862b-5c80249decdb |
| source.excerpts.107.value | Cette fontaine , qui était connue depuis fort longtemps par les gens du pays , n ' est ulilisée comme agent thérapeutique que depuis l ' année 183t j elle émerge d ' un calcaire schisteux et débite 24 hectolitres par jour .Son eau claire , limpide et transparente , a une odeur hépatique trtts accusée et st savp ) ) ) ' t ~ cronent saline « ' est pas désagréable ; sa densité est de i , 00067i .Après une longue exposition à l ' air , cette eau sulfureuse froide devient verd & tre et laisse déposer une matière blanchâtre au fond des vases . |
| source.excerpts.107.words.0 | désagréable |
| source.excerpts.107.words.1 | odeur |
| source.excerpts.107.words.2 | hépatique trtts accusée |
| source.excerpts.107.words.3 | cronent |
| source.excerpts.107.words.4 | Son eau claire |
| source.author.0.@id | http://data.odeuropa.eu/actor/472733de-10d2-5f00-833e-cd505362bce2 |
| source.author.0.label | James Léon Macquarie |
| source.label | Villes d'eaux de l'étranger. II. Allemagne, Angleterre, Autriche, Belgique, Suisse / par J.-L. Macquarie ; avec la collaboration de MM. les médecins, chimistes et ingénieurs hydrologues de la France et de l'étranger |
| source.url | https://gallica.bnf.fr/ark:/12148/bpt6k106890d |
| source.date | 1892 |
| source.language | fr |
...
| relevantExcerpt | http://data.odeuropa.eu/source/09a711b7-b768-5c00-8fd7-a26b38696cc0/fragment/05a62419-181f-545c-8dc3-0c7a23f55ac4 |
