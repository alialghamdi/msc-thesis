...
| @id | http://data.odeuropa.eu/smell/0ed32fc5-b665-5396-9b19-1ce4b29da0cc |
| @graph | http://data.odeuropa.eu/gallica |
| label | odeur |
| source.@id | http://data.odeuropa.eu/source/effd7406-6a0c-56bb-bf24-cbb555f1c044 |
| source.excerpts.0.@id | http://data.odeuropa.eu/source/effd7406-6a0c-56bb-bf24-cbb555f1c044/fragment/03daf5b0-6599-508b-8494-b67a913c38bf |
| source.excerpts.0.value | Myristica ; nguentaria , & ; Aromatites .Pendant L verdeur elle est enveloppée de deux corces , mais quand elle vient à ma - mité celle de dessus se fend , & laisse aroistre la seconde qui est tendre , & ln odorante .On appelle cette der - erc elèorceiMacis , & impropre - ent Fleurde Muscade . |
| source.excerpts.0.words.0 | odorante |
| source.excerpts.0.words.1 | verdeur |
| source.excerpts.0.words.2 | Pendant L |
| source.excerpts.1.@id | http://data.odeuropa.eu/source/effd7406-6a0c-56bb-bf24-cbb555f1c044/fragment/03f343e4-3b0c-54ac-b85a-e52c61e78f5f |
| source.excerpts.1.value | CHAPITRE VIII .Difttllation d ' une Plante non odorante ) telle qaejl te Chardon bénit , & son Sel , E ffintiel .P Renez une bonne quantité de Chardon benit , lors qu ' il dl : en sa plus grande vigueur : Pi - lez - le dans un Mortier , & en remplissez le tiers d ' un Alembic , tirez par expression une quantité suffisante de Suc d ' autre Chardon benit , & le versez dans l ' Alembic , afin que les herbes n ' âgeant dans le Suc , ne soient point en danger de s ' attacher au fond de la Cucurbite pendant la distillation : Adaptez un Recipient au Cha - piteau , & ayant lutté les jointures avec de la vessie moüillée , faites di - iller par un feu du second degré en - ron la moitié d ' eau de ce que vous irez mis de Suc , cette eau est Suprifique . |
| source.excerpts.1.words.0 | Plante |
| source.excerpts.1.words.1 | odorante |
| source.excerpts.1.words.2 | non |
| source.excerpts.1.words.3 | Chardon |
| source.excerpts.2.@id | http://data.odeuropa.eu/source/effd7406-6a0c-56bb-bf24-cbb555f1c044/fragment/0e8ae30b-e73b-5ccb-98a8-b8a71d6b410f |
| source.excerpts.2.value | MA RQJTE S .' Esprit de Therebentine est pro ~ prement une huille Etherée méavec un peu de Phlegme & de Sel de essentiel qui la rend aperitive : t cet Esprit qui donne l ' odeur à la erebentinc .Il faut beaucoup de feu pour tirer la derniere huile , & elle devient rouge , à cause des Fuliginofirez qui retombent dessus , avant qu ' elle soit sortie de la Connuë . |
| source.excerpts.2.words.0 | odeur |
| source.excerpts.2.words.1 | Sel de |
| source.excerpts.2.words.2 | Esprit |
| source.excerpts.2.words.3 | huille |
| source.excerpts.2.words.4 | Phlegme |
| source.excerpts.2.words.5 | Esprit de Therebentine |
| source.excerpts.3.@id | http://data.odeuropa.eu/source/effd7406-6a0c-56bb-bf24-cbb555f1c044/fragment/1b15813f-9837-5484-95be-1033a7674b84 |
| source.excerpts.3.value | Diflillation du Tartre .R Emplissez les deux tiers d ' une Cornue de Tartre grossierement pul / enfé ; Placez vostre Cornue dans le fourneau de Reverbere , & y ayant adapté un grand Bâlon ou Recipient , commencez Ja distilation par un trespetit feu pendant trois heures pOUl eschauffer la Cornuë , & faire sortir le Phlegme goutte à goutte ; Jettez cette Eau Insipide comme inutile , & ayant radapté le Bâlon lutez exactement les joinctures , il faut augmenter le feu peu à peu , & vous verrez les Esprits qui rempliront le Bâlon de nuages : Continuez - le , afin que l ' huile forte aussi : puis quand il ne viendra plus rien , laissez refroidir les vaisseaux , & les deluttez : Versez ce que le Recipient contiendra , dans un Entonnoir garnv de papier gris , afin que l ' Esprit se filtre , & se feparc clc huile crasse , & noire qui restera dans filtre : Gardez cette huile dans une ~ iole , elle est bonne pour faire sentir ~ ns les vapeurs Hystericques : Eiie roit propre pour en frotter les parles attaquées de Paralisie , & pour les ~ luleurs froides : mais à cause de la op grande puanteur on ne s ' en [ crt ) w ( .Versez l ' Esprit dans un Alembic : verre , & le reébnez en le distint au feu de sable , il est bon cone la Paralisie , l ' Astme , & le Scor ~ it , il pousse par les urines , & par s sueurs . |
| source.excerpts.3.words.0 | puanteur |
| source.excerpts.3.words.1 | grande |
| source.excerpts.4.@id | http://data.odeuropa.eu/source/effd7406-6a0c-56bb-bf24-cbb555f1c044/fragment/3077fb76-c10d-5ffd-a1a5-6d1da8c465d6 |
| source.excerpts.4.value | » Tous les Acides sont cardiacques , & bons contre la malignité des hu - meurs lors qu ' elle est causée par une trop grande agitation , parce qu ' il les fixe Gç , c coagule moderant leur mouvement .Ainsi dans les lieux oé l ' air est corrompu & empesté , le Vi - naigre est un bon preservatif , il en faut prendre tous les matins une de - my cuillerée à jeun ; mais dans les maladies qui proviennent d ' une hu - meur Tartareuse , comme dans les melancholies hypochondriacques , ll est plûtost nuisible qu ' utile , parce qu ' il fixe encore davantage l ' hu - meur .CHAPITRE XI . |
| source.excerpts.4.words.0 | air |
| source.excerpts.4.words.1 | empesté |
| source.excerpts.4.words.2 | tous les matins |
| source.excerpts.4.words.3 | preservatif |
...
| source.excerpts.19.words.5 | urine |
...
| source.excerpts.31.value | lild on n ' en donne que la dose prel crite , de forte qu ' il n ' est point beloii d ' enlever ses parties volatiles en le ~ toi ressant , ny de le mesler avec d ' autre matières qui l ' empeschent d ' opercr comme il feroit s ' ll estoit seul , ou qi retardent son effet .C ' est au Medecin quand il le donne , a juger s ' il est De soin d ' une drogue Hystericque Cardiacque , avec laquelle il peut i , faire mesler sur le champ .Je ne m ' arresteray pas icy a ex - i miner si l ' Opium est froid ou Ch . |
