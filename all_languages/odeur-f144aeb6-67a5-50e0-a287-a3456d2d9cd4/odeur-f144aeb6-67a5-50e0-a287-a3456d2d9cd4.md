...
| @id | http://data.odeuropa.eu/smell/f144aeb6-67a5-50e0-a287-a3456d2d9cd4 |
| @graph | http://data.odeuropa.eu/gallica |
| label | odeur |
| source.@id | http://data.odeuropa.eu/source/19e476cf-5c49-53be-8d3d-13fc4580f116 |
| source.excerpts.0.@id | http://data.odeuropa.eu/source/19e476cf-5c49-53be-8d3d-13fc4580f116/fragment/081f3032-9b5a-5564-b4c0-c25bace63cc4 |
| source.excerpts.0.value | licre ." ■ > Mais fur lo coáimencement dela nuit voicy Venus reuenirdu banquet nuptial fort bien trempéem devin Ôc parfumée de baumes ; ayânt le ebrps tout barré de chappeaux ôc d ' escharpes nde roses , vermeilles : ôc voyant auec quclîe diligence on auoit expédié cçtte merueisieufe tasche : Ce n ' est , luydit - elle , ny detoy ny de tes mains que vient çètte besogne , mesch ' ante ribaúde que tués : mais .- bien de ceíuy qui à ton malheur , voire au sien , s ' est amouraché de tpy . |
| source.excerpts.0.words.0 | parfumée |
| source.excerpts.0.words.1 | baumes |
| source.excerpts.1.@id | http://data.odeuropa.eu/source/19e476cf-5c49-53be-8d3d-13fc4580f116/fragment/1b3054ab-76a1-58fa-8e84-d8e8ca0a4f67 |
| source.excerpts.1.value | .] HA raisin d ' approprier < span style = " color : Slategray ; " > h < / span > < / p > < hr > < p > vin & les parfums k Venus , attendu quece , font autant d ' allumettes k luxure < span style = " color : Slategray ; " > f < / span > & les Anciens < span style = " color : Slategray ; " > a < / span > bon droit ont - feìnìPriapefilsde Venus & deBíacctíiit , pdr < span style = " color : Slategray ; " > vue < / span > affeì , benne conieBure - & lt ; çar ceux qui sont < span style = " color : Slategray ; " > fub - - .< / span > íets < span style = " color : Slategray ; " > an < / span > vin , sont < span style = " color : Slategray ; " > aufii < / span > fort enclins < span style = " color : Slategray ; " > a < / span > Venus . |
| source.excerpts.1.words.0 | vin |
| source.excerpts.1.words.1 | parfums |
| source.excerpts.2.@id | http://data.odeuropa.eu/source/19e476cf-5c49-53be-8d3d-13fc4580f116/fragment/1d76abd6-b966-55e6-9ef2-4d1ad52a446e |
| source.excerpts.2.value | GieL > engendrée : de la merj .2iour rie au milieu des ondes : fust - ce , dis - ic , Venus , elle mesme , enuironnée de toutes la compagnie : • des Grâces ; suiuie de toute ìa bande des Cupidons > ceinte de son , baudrier OUÏ S demy - cciiitâ parfumée de cinnamome , 8c qu ' elle degoutast du * bausme à guise de rosée : si , .elle se vient présenter auec . |
| source.excerpts.2.words.0 | parfumée |
| source.excerpts.2.words.1 | cinnamome |
| source.excerpts.2.words.2 | bausme |
| source.excerpts.3.@id | http://data.odeuropa.eu/source/19e476cf-5c49-53be-8d3d-13fc4580f116/fragment/1f237668-28eb-5a94-a7fd-d33363f4a113 |
| source.excerpts.3.value | Ainsi VEmpereur Commode ( tesmoin < span style = " color : Slategray ; " > ILerodian ) < / span > la pestilence asfligeant - la ville de Rome ' , fi relira dans Laurc ' nts - , parce que < span style = " color : Slategray ; " > lá < / span > fráifcheur dèla region & gt ; esi V odeur des lauriers quil ' ombragent - , sertde beaucoup contre la contagion .Et dans la ville chacun , , par Vadmis des Médecins , fi rempliffoit les narines ejr les oreilles d ' odeurs fouisue s , lesquelles o ' ecupans les conduits dessèntimens , empefchoient dereceuóir l ' air empesté .Y < span style = " color : Slategray ; " > Y . |
| source.excerpts.3.words.0 | air |
| source.excerpts.3.words.1 | odeurs |
| source.excerpts.3.words.2 | empesté |
| source.excerpts.3.words.3 | narines |
| source.excerpts.3.words.4 | la ville |
| source.excerpts.3.words.5 | fouisue |
| source.excerpts.4.@id | http://data.odeuropa.eu/source/19e476cf-5c49-53be-8d3d-13fc4580f116/fragment/337e40ef-480b-5ced-be59-6415fac04f57 |
| source.excerpts.4.value | < / p > < p > ■ Mais Venus < span style = " color : Slategray ; " > n < / span > ayant fçeu courir affez , vïfie au .secours , recueillitfin sang ■ ; V inspira de tres - fiuèfue < / p > < p > , odeur enmemoire deiùy ; dónna fa couleur aux ro : fis < span style = " color : Slategray ; " > y < / span > < span style = " color : Slategray ; " > ési < / span > travifmuaie corps en vne steur vermeille comme sang , qui fut nommée Adoniurn .Le sang auffi . |
| source.excerpts.4.words.0 | odeur |
| source.excerpts.4.words.1 | enmemoire |
| source.excerpts.4.words.2 | steur |
| source.excerpts.5.@id | http://data.odeuropa.eu/source/19e476cf-5c49-53be-8d3d-13fc4580f116/fragment/3d12d11d-bace-5720-adfc-b133b753a675 |
| source.excerpts.5.value | < span style = " color : Slategray ; " > c < / span > Les Harpies .] La lecture des Poètes nous ' apprend comme les Harpies , oyseaux gloutons , files dr puants infectaient par leur attouchement la table dePhìnte , ( Roy d ' Arcadie aueugle < span style = " color : Slategray ; " > t < / span > iufiques k tant que chaste es parles Archinauchers elles s ' enfuirent aux Istes Strofhades .Voyez , - en le discours au fiptiefime liure chapitre G . |
| source.excerpts.5.words.0 | table |
...
| source.excerpts.19.@id | http://data.odeuropa.eu/source/19e476cf-5c49-53be-8d3d-13fc4580f116/fragment/9bcac725-2df4-5965-bee0-648b09246296 |
...
| source.excerpts.25.value | On en tire le íus tant des pommes que de la tige en les tondant par la pointe .V odeur en est forte , mais celle de la racine dr des pommes test encore dauantage .Les pommes meures fi sèchent k Cambre ; leur fuc ' s ' efpaiffìt au £ 0Itil . |
